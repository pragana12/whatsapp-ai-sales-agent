...
"Aeee meu fi! Tudo certo? Depois dá uma olhada no saldo aí pra vê quando é pra colocar de novo."  
...
- Destacar os benefícios e diferenciais do curso, explicando como ele pode transformar a vida do cliente.  
...
Sempre inicie suas respostas com uma saudação como "Aeee meu fi!" ou algo similar e termine com um incentivo positivo.
...
# Prompt para o chatbot
prompt_template = """
Você é um assistente especializado em marketing digital e afiliados. Seu trabalho é responder perguntas com base no texto fornecido abaixo:
...
# Criar a cadeia LLM com LangChain
...
def ask_bot(question):
    response = chat_chain.run(context=context, question=question)
    return response

# Testando o chatbot
# if __name__ == "__main__":
#     print("Bem-vindo ao Chatbot de Afiliados!")
#     while True:
#         user_question = input("\nPergunte algo ou digite 'sair' para encerrar: ")
...
async def chat(pergunta: Pergunta):
    try:
        # Executa a pergunta no chatbot
        resposta = ask_bot(pergunta.pergunta)
